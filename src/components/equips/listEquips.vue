...
<script>
import clientData from "@/components/equips/dialog/clientData";
import productPreview from "@/components/equips/dialog/productPreview";
import itemCard from "@/components/equips/models/itemCard";
export default {
  components: {
    productPreview,
    itemCard,
